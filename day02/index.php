        ...
        <form method="POST" action="users.php">
            ...
            <div class="mb-3">
                ...
                <textarea name="address" class="form-control" id="address"
                    rows="3"><?php echo ($old && $old['address']) ? $old['address'] : '' ?></textarea>
            ...
            <select name="country" class="form-select" aria-label="Default select example">
                ...
                <option <?php echo ($old && $old['country'] && $old['country'] == 'EG') ? 'selected' : '' ?> value="EG">
                    Egypt</option>
                <option <?php echo ($old && $old['country'] && $old['country'] == 'UK') ? 'selected' : '' ?> value="UK">
                    United Kingdom</option>
                <option <?php echo ($old && $old['country'] && $old['country'] == 'US') ? 'selected' : '' ?> value="US">
            ...
            <div class="row my-3">
                ...
                <div class="form-check col-2">
                    <input class="form-check-input" type="radio" name="gender" id="male" value="male"
                        <?php echo ($old && $old['gender'] && $old['gender'] == 'male') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="male">Male</label>
                </div>
                <div class="form-check col-2">
                    <input class="form-check-input" type="radio" name="gender" id="female" value="female"
                        <?php echo ($old && $old['gender'] && $old['gender'] == 'female') ? 'checked' : '' ?>>
            ...
            <div class="row">
                ...
                <div class="mb-3 form-check col-4">
                    <input name="langs[]" type="checkbox" class="form-check-input" id="go" value="Go Lang"
                        <?php echo ($old && $old['langs'] && in_array("Go Lang", $old["langs"])) ? 'checked' : '' ?>>
            ...
            <div class="mb-3">
                ...
                <input name="username" type="text" class="form-control" id="username"
                    value="<?php echo ($old && $old['username']) ? $old['username'] : '' ?>">
            ...
            <div class="mb-3">
                ...
                <input name="pass" type="text" class="form-control" id="pass"
                    value="<?php echo ($old && $old['pass']) ? $old['pass'] : '' ?>">
            ...
            <div class="mb-3">
                ...
                <input name="department" readonly
                    value="<?php echo ($old && $old['department']) ? $old['department'] : '' ?>" type="text"
